...
export default function DashboardLayout() {
  return (
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      <aside style={{ width: "250px", background: "rgb(217, 238, 220)", padding: "20px" }}>
        <div className="flex space-x-4 items-center mb-10 mt-20">
  <NavLink to="/user/home" className="flex items-center space-x-4">
    ...
    <h1 className="text-xl font-semibold text-[#469349]"> HOMENEST</h1>
        ...
        <h2 className="text-lg font-semibold mb-7  mt-10 text-[#507452]">Menu</h2>
        <nav>
  <div className="flex flex-col space-y-1">
    <NavLink
      ...
      className={({ isActive }) =>
        `flex items-center px-3 py-2 rounded-md ${
          isActive ? "bg-[#ff9994]" : "hover:bg-indigo-100"
        }`
      }
    >
      <FaChartPie className="text-xl mr-3 text-[#469349]" />
    ...
    >
      <MdOutlinePostAdd className="text-xl mr-3 text-[#469349]" />
    ...
    >
      <FaFileContract className="text-xl mr-3 text-[#469349]" />
    ...
    >
      <MdOutlineAccountCircle className="text-xl mr-3 text-[#469349]" />
    ...
    >
      <FaClipboard className="text-xl mr-3 text-[#469349]" />
