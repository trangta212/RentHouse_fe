...
//           const fullData = {
//             ...depositData,
//             payment_method: paymentData?.method || "MOMO", // Phương thức thanh toán là MoMo
//             trans_id: paymentData?.code || "N/A", // Mã giao dịch từ MoMo
//             order_id: paymentData?.code || "N/A", // Mã đơn hàng (có thể dùng trans_id từ MoMo)
//             request_id: paymentData?.code || "N/A", // Mã yêu cầu (có thể dùng trans_id từ MoMo)
//             refund_status: "not_refunded", // Hoàn tiền chưa thực hiện
//             trans_id: data.transId, // Lưu transId (3300750913)
//             order_id: data.orderId, // Lưu orderId (MOMO1745571997570)
//             partnerCode: searchParams.get("partnerCode") || "MOMO", // Lưu partnerCode
//             // refund_reason: null, // Không có lý do hoàn tiền
//             // cccd_images: storedFileList.map(file => file.originFileObj),
//             // cccd_images: cccdImages, // Gửi dưới dạng chuỗi
//           };
